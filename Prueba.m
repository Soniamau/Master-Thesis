...
cnotghz1=CNOT1A*CNOT2B*CNOTC3*ghz2;
cnotghz2=CNOT1A*CNOTB2*CNOT3C*ghz2;
cnotghz3=CNOTA1*CNOT2B*CNOT3C*ghz2;
ghzX6=Tensor(cnotghz1,cnotghz2,cnotghz3); %dim=262144 order (1 2 3, A B C, 4 5 6, D E F, 7 8 9,G H I)
